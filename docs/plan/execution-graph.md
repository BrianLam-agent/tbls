...
| `05-experiments-code-hygiene.md` | `05-experiments-hygiene` | none | `IMPLEMENTED` |
| `06-metrics-logging-visualization.md` | `06-metrics-logging-viz` | `05-experiments-hygiene` (sequencing preference, not a correctness dependency) | `IMPLEMENTED` |
